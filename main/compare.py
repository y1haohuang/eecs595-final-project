...
from config import EMBEDDINGS_EXPORT_PATH, MULTI_EMBEDDINGS_EXPORT_PATH, TMP_DIR, ENGLISH_TEST_TARGET_WORDS, TEST_DATA_RESULTS_DIR, \
...
def main():
    ...
    # #
    acc, rho = run_english_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island, emb_type, emb_dim, window, iter, mean_centering, unit_vectors, use_op)
    acc_list.append(acc)
    rho_list.append(rho)

    acc, rho = run_german_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island, emb_type, emb_dim, window, iter, mean_centering, unit_vectors, use_op)
    acc_list.append(acc)
    rho_list.append(rho)

    acc, rho = run_latin_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island, emb_type, emb_dim, window, iter, mean_centering, unit_vectors, use_op)
    acc_list.append(acc)
    rho_list.append(rho)

    acc, rho = run_swedish_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island, emb_type, emb_dim, window, iter, mean_centering, unit_vectors, use_op)
    acc_list.append(acc)
    rho_list.append(rho)
...
def run_swedish_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island,
                        emb_type, emb_dim, window, iter, mean_centering, unit_vectors, use_op):
    print('-' * 70)
    print('Swedish')
    ...
    # config
    # corp1_emb_file = 'w2v.swedish_corpus1.100_window-5_iter-5_min-count-5_aligned.vec'
    # corp2_emb_file = 'w2v.swedish_corpus2.100_window-5_iter-5_min-count-5_aligned.vec'
    ...
    rho, acc, bin_thld, min_neighb_cnt = compare(SWEDISH_TEST_CORPUS_1, SWEDISH_TEST_CORPUS_2, corp_1_emb, corp_2_emb, target_words, SWEDISH_TEST_GOLD_TASK_1,
                                                 ...
                                                 save_file_binary=save_file_binary, one_minus=True, use_op=use_op)
...
def run_latin_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island,
    ...
    # corp1_emb_file = 'w2v.latin_corpus1.100_window-5_iter-5_min-count-5_aligned.vec'
    # corp2_emb_file = 'w2v.latin_corpus2.100_window-5_iter-5_min-count-5_aligned.vec'
    ...
    # corp1_emb_file = "multi_" + "lat1" + "_e30_d300_vs2e-4_lr1e-5_margin1_0.vec"
    # corp2_emb_file = "multi_" + "lat2" + "_e30_d300_vs2e-4_lr1e-5_margin1_0.vec"
...
def run_german_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island,
    ...
    # corp1_emb_file = 'w2v.german_corpus1.100_window-5_iter-5_min-count-5_aligned.vec'
    # corp2_emb_file = 'w2v.german_corpus2.100_window-5_iter-5_min-count-5_aligned.vec'
...
def run_english_default(task_1_dir, task_2_dir, reverse_emb, use_bin_thld, use_nearest_neigbh, use_island,
    ...
    # corp1_emb_file = 'w2v.english_corpus1.100_window-5_iter-5_min-count-5_aligned.vec'
    # corp2_emb_file = 'w2v.english_corpus2.100_window-5_iter-5_min-count-5_aligned.vec'
    ...
    # corp1_emb_file = "multi_" + "eng1" + "_e30_d300_vs2e-4_lr1e-5_margin1_0.vec"
    # corp2_emb_file = "multi_" + "eng2" + "_e30_d300_vs2e-4_lr1e-5_margin1_0.vec"
...
def compare(corpus1_path, corpus2_path, src_emb_path, trg_emb_path, target_words_path, gold_file_task1, gold_file_task2, reverse, use_binary_threshold,
            ...
            one_minus=False, topn=100, use_op=False):
    """
    ...
    for target_word in tqdm(target_words):
        ...
        sim, sim_to_orig_word, sim_to_trans_vec = compare_sense(target_word, src_emb, trg_emb, trans_matrix, topn, use_op)
